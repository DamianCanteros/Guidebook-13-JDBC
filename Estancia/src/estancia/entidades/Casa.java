...
public class Casa {
    ...
    public Casa(int id_casa, String calle, int numero, int codigo_postal, String ciudad, String pais, Date fecha_desde, Date fecha_hasta, int tiempo_minimo, int tiempo_maximo, double precio_habitacion, String tipo_vivienda, int count) {
